...
PACKAGECONFIG[fvk-logs] = "-DCMAKE_BUILD_TYPE=Debug,-DCMAKE_BUILD_TYPE=Release"
...
EXTRA_OECMAKE:class-native += " \
    ...
    -D FILAMENT_LINUX_IS_MOBILE=OFF \
...
do_configure:prepend:class-target () {
    ...
    cp ${UNPACKDIR}/ImportExecutables-Debug.cmake ${S}/ImportExecutables-Debug.cmake
}
